...
namespace AirLineAPI.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(AirContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customers>> PostCustomers(Customers customers)
        {
            ...
            {
                if (CustomersExists(customers.Staff_ID))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetCustomers", new { id = customers.Staff_ID }, customers);
        }
        ...
        {
            return _context.Customers.Any(e => e.Staff_ID == id);
        }
    }
}
